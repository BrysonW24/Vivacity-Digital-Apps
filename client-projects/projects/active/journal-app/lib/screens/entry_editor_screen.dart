...
class _EntryEditorScreenState extends State<EntryEditorScreen> {
  ...
  Future<void> _saveEntry() async {
    ...
    // Title validation
    if (title.isEmpty) {
      _showValidationError('Please add a title to your entry');
    ...
    if (title.length > 200) {
      _showValidationError('Title must be less than 200 characters');
      _titleFocusNode.requestFocus();
      return;
    }
    ...
    // Content validation
    if (content.isEmpty) {
      _showValidationError('Please write something in your entry');
      _contentFocusNode.requestFocus();
      return;
    }

    if (content.length < 10) {
      _showValidationError('Content must be at least 10 characters long');
      _contentFocusNode.requestFocus();
      return;
    }
